...
model PTTL_SF_basic_20160701 "SF + Mdot_source + SinkP"
 ...
 Sources.FullDay_20160701.DNI DNI
    annotation (Placement(transformation(extent={{-90,-12},{-70,8}})));
  Sources.FullDay_20160701.theta theta
    annotation (Placement(transformation(extent={{-90,44},{-70,64}})));
  Sources.FullDay_20160701.V_wind v_wind
    annotation (Placement(transformation(extent={{-90,70},{-70,90}})));
  Sources.FullDay_20160701.T_amb T_amb
    annotation (Placement(transformation(extent={{-90,16},{-70,36}})));
  Sources.FullDay_20160701.M_dot_htf m_dot_htf
    annotation (Placement(transformation(extent={{-90,-96},{-70,-76}})));
  Sources.FullDay_20160701.T_htf_su T_htf_su
  ...
  Sources.FullDay_20160701.Focus focus
    annotation (Placement(transformation(extent={{-90,-38},{-70,-18}})));
  Sources.FullDay_20160701.T_htf_ex t_htf_ex
